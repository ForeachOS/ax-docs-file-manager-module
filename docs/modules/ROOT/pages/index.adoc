...
for local and Amazon S3 Bucket storage. It's also possible to provide your own `FileRegistry`.
...
To handle file upload and persistance the `FileReference` entity  can be used.
